...
namespace System.Window.Menu.Scroll.Popup
{
    ...
    {
        [Separator("Popup Menu Settings")] [SerializeField]
        private float width;
        ...
        public IEnumerator OpenWindow(List<T> options, OnConfirmFunc onConfirmCallback = null,
        ...
        private void SetWindowSize() {
            ...
            OptionMenuItems.ForEach(menuItem =>
                menuItem.Transform.localPosition = new Vector3(padding.x, padding.y + spacing * menuIndex--));
        }
