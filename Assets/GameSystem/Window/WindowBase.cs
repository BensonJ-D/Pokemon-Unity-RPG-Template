...
namespace System.Window
{
    ...
    {
        [Separator("Window Settings")] [SerializeField]
        protected bool isChildWindow;

        [ConditionalField(nameof(isChildWindow), true)] [SerializeField]
        ...
        protected virtual IEnumerator BeforeOpen() {
            return null;
        }
        ...
        protected virtual IEnumerator BeforeClose() {
            return null;
        }
