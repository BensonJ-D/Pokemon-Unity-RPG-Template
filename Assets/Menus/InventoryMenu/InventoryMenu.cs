...
namespace Menus.InventoryMenu
{
    ...
    {
        [Separator("Inventory Menu Settings")] [SerializeField]
        ...
        private Characters.Inventories.Inventory _inventory;
        ...
        public IEnumerator OpenWindow(Characters.Inventories.Inventory inventory, PokemonParty party,
        ...
        private IEnumerator DefaultOnConfirmCallback(InventoryData choice) {
            var options = new List<InventoryPopupMenuOption>
                {InventoryPopupMenuOption.Use, InventoryPopupMenuOption.Toss};
        ...
        private IEnumerator OnPopupCancel() {
            return popupMenu.CloseWindow();
        }
        ...
        private IEnumerator OnTossCancel() {
            return numberSelector.CloseWindow();
        }
        ...
        protected override void OnOptionChange(IMenuItem<InventoryData> previousOption,
            IMenuItem<InventoryData> newOption, bool cursorShifted) {
