...
namespace Battle.Controller
{
    ...
    {
        private readonly GameObject _levelUpWindowPrefab = Resources.Load("Prefabs/LevelUpWindow") as GameObject;

        private readonly Dictionary<Pokemon, HashSet<Pokemon>> _pokemonObserved;
        private bool _actionChosen;
        private Task _actionMenuTask;
        private Task _inventoryMenuTask;
        private Task _partyMenuTask;

        public LocalBattleController(Player player, ApplyDamageCallback applyDamageCallbackCallback,
            ActionMenu actionMenu, MoveMenu moveMenu, PartyMenu partyMenu,
        ...
        private MoveMenu MoveMenu { get; }
        private PartyMenu PartyMenu { get; }
        private InventoryMenu InventoryMenu { get; }
        ...
        private IEnumerator ChooseAction(PokemonCombatant combatant, List<PokemonCombatant> targets,
            bool isCancellable) {
            _actionChosen = false;
        ...
        private IEnumerator OpenPartyMenu() {
            ...
            yield return PartyMenu.OpenWindow(Party, true, onCancelCallback: OnPartyCancel);
        }
        ...
        protected override void OnPokemonSwitch(PokemonCombatant combatant,
